...
namespace SimpleUI
{
    ...
    public class UIMenu
    {
        ...
        {
            DrawCustomText(Title, TitleFontSize, GTA.Font.HouseScript, TitleColor.R, TitleColor.G, TitleColor.B, TitleColor.A, xPosBG, yPosTitleText, xPosItemText, xPosItemValue, TextJustification.Center); //Draw title text
            ...
            foreach (UIMenuItem item in _itemList)
            {
                ...
                if (ScrollOrNotDecision)
                {
                    ...
                    {
                        DrawCustomText(item.Text, ItemTextFontSize, ItemTextFontType, HighlightedItemTextColor.R, HighlightedItemTextColor.G, HighlightedItemTextColor.B, HighlightedItemTextColor.A, xPosItemText, yPosItem + YPosBasedOnScroll * posMultiplier, xPosItemText, xPosItemValue); //Draw highlighted item text

                        if (item.Value != null)
                        { DrawCustomText(Convert.ToString(item.Value), ItemTextFontSize, ItemTextFontType, HighlightedItemTextColor.R, HighlightedItemTextColor.G, HighlightedItemTextColor.B, HighlightedItemTextColor.A, xPosItemValue, yPosItem + YPosBasedOnScroll * posMultiplier, xPosItemText, xPosItemValue, TextJustification.Right); } //Draw highlighted item value
                        ...
                        if (item.Description != null)
                        {
                            ...
                            DrawCustomText(item.Description, ItemTextFontSize, ItemTextFontType, DescriptionTextColor.R, DescriptionTextColor.G, DescriptionTextColor.B, DescriptionTextColor.A, xPosItemText, yPosItem + YPosDescBasedOnScroll * posMultiplier, xPosItemText, xPosItemValue, TextJustification.Left, true); // Draw description text at bottom of menu
                    ...
                    {
                        DrawCustomText(item.Text, ItemTextFontSize, ItemTextFontType, DefaultTextColor.R, DefaultTextColor.G, DefaultTextColor.B, DefaultTextColor.A, xPosItemText, yPosItem + YPosBasedOnScroll * posMultiplier, xPosItemText, xPosItemValue); //Draw item text

                        if (item.Value != null)
                        { DrawCustomText(Convert.ToString(item.Value), ItemTextFontSize, ItemTextFontType, DefaultTextColor.R, DefaultTextColor.G, DefaultTextColor.B, DefaultTextColor.A, xPosItemValue, yPosItem + YPosBasedOnScroll * posMultiplier, xPosItemText, xPosItemValue, TextJustification.Right); } //Draw item value
        ...
        public static void DrawCustomText(string Message, float FontSize, GTA.Font FontType, 
            int Red, int Green, int Blue, int Alpha, float XPos, float YPos, float wrapX, float wrapY, 
            TextJustification justifyType = TextJustification.Left, bool ForceTextWrap = false, string textType = "jamyfafi")
        {
            Function.Call(Hash._SET_TEXT_ENTRY, textType); //Required, don't change this! AKA BEGIN_TEXT_COMMAND_DISPLAY_TEXT
