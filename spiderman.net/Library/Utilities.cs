    ...
    public static class Utilities
    {
        ...
        public static void ShockPed(Ped ped, int damage)
        {
            ...
            Function.Call(Hash._0xE3A7742E0B7A2F8B,
                ...
                pedPos.X, ped.Position.Y, ped.Position.Z, damage, true, 0x3656C8C1, Game.Player.Character, false, true, 500000f, Game.Player.Character);
        }
        ...
        public static void CreateParticleChain(Vector3 pointA, Vector3 pointB, Vector3 rotationOffset, float nodeSize = 1f, float noiseMultiplier = 0.5f,
            string particleAsset = "core", string particleName = "ent_ray_prologue_elec_crackle_sp", float particleScale = 0.5f)
        {
            // Clamp the noise.
            ...
            var currentRotation = Quaternion.FromToRotation(Vector3.WorldUp, pointBDirection); // Calculate the initial rotation.
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                float dX = randomDirection.X * distancePercentage;
                float dY = randomDirection.Y * distancePercentage;
                ...
                var desiredRotation = Quaternion.FromToRotation(Vector3.RelativeFront, currentToNextDirection) * Quaternion.Euler(rotationOffset);

                // Spawn the particle.
                Library.GTAGraphics.StartParticle(particleAsset, particleName, currentPosition,
