...
using GTAGraphics = spiderman.net.Library.GTAGraphics;
...
namespace spiderman.net.Abilities
{
    public class WebSwing : SpecialAbility
    {
        ...
        private float _webSwingCooldown = 0f;
        ...
        public override void Update()
        {
            ...
            {
                // Only do the check once we press jump, since
                // every frame might cause some serious dips.
