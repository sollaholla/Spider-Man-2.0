    ...
    public class WallCrawl : SpecialAbility
    {
        ...
        private void UpdateClimbing(Vector3 surfacePosition, Vector3 surfaceNormal)
        {
            ...
            while (!cancelClimb)
            {
                ...
                if (surfaceNormal != result.SurfaceNormal)
                {
                    ...
                    Move(/*cam, */surfaceNormal, attachmentObject, ref camDirection, ref moveDirection, movement, false);
                }
        ...
        private void HandleEject(ref bool cancelClimb, Entity attachmentObject)
        {
            ...
            if (Game.IsDisabledControlJustPressed(2, Control.Jump))
            {
                ...
                PlayerCharacter.Task.PlayAnimation("swimming@swim", "recover_flip_back_to_front", 8.0f, -4.0f, 500, AnimationFlags.AllowRotation, 0.0f);
        ...
        private void PlayAnim(Prop attachmentObject, string animationDict, string animationName, float xAngle, float zOffset)
        {
            ...
            ref Vector3 camDirection, ref Vector3 moveDirection, Vector3 movement, bool lerp = true)
        {
            ...
            {
                var targetDir = /*attachmentObject.Position - *//*cam*//*GameplayCamera.Position*/GameplayCamera.Direction + Vector3.WorldUp * 0.5f;
                targetDir.Normalize();
